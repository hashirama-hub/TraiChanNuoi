...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><i class="fa fa-envelope"></i><a href="/tin-tuc/danh-sach.html">Danh sách tin tức</a></li>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<form role="form" action="/tin-tuc/edit.html" method="post" id="frmValidate" enctype="multipart/form-data">
						 {{ csrf_field() }}
                         <input type="hidden" name="ID" value="{{ $tintuc->ID }}">
						<div class="box-body">
							<div class="form-group col-md-8">
								<label for="exampleInputPassword1">Tiêu đề</label>
								<input type="text" class="form-control" value="{{ $tintuc->TieuDe }}" name="TieuDe" placeholder="Nhập tiêu đề bài viết..." required>
							</div>
							...
							<div class="form-group col-md-4">
                                ...
                                <select name="LoaiTin_ID" class="form-control">
                                    ...
                                    @foreach($loaitin as $item)
                                         <option value="{{ $item->ID }}" {{($item->ID == $tintuc->LoaiTin_ID) ? 'selected' : '' }}>{{ $item->Ten }}</option>
                                    @endforeach
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <br>
                                <img id="blah" src="{{asset('/assets/img/news/' . $tintuc->Anh)}}" alt="your image" width="100px" />
                                <input id="imgInp" name="Anh" type="file" style="display:none;" accept="image/*">

                            </div>
                            <div class="form-group col-md-12">
                                <label>Mô tả</label>
                                <textarea name="NoiDung" id="NoiDung" class="form-control" rows="3" placeholder="Nhập nội dung">
                                    {{ $tintuc->NoiDung }}
                                </textarea>
                            </div>
						</div><!-- /.box-body -->
